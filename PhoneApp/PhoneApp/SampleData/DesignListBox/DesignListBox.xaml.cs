...
namespace Expression.Blend.SampleData.DesignListBox
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class DesignListBox { }
#else

	public class DesignListBox : INotifyPropertyChanged
	{
		...
		public DesignListBox()
		{
			try
			{
				Uri resourceUri = new Uri("/PhoneApp;component/SampleData/DesignListBox/DesignListBox.xaml", UriKind.RelativeOrAbsolute);
